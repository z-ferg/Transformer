...
class NGramLanguageModeler(nn.Module):
    def __init__(self, vocab_size, embedding_dim, context_size):
        ...
        self.linear1 = nn.Linear((context_size * 2) * embedding_dim, embedding_dim) # Project large input vector into vector of embedding_dim
        self.linear2 = nn.Linear(embedding_dim, vocab_size)                         # Map the projection to vector of size vocab
...
def main():
    ...
    print(f'Total overlap beteween glove and ag-news dataset: {count}')
